...
class StarScore extends React.Component {
     ...
     */
    renderScore(){
        let wm_poi_score = this.props.score || ''; //|| 是或者的意思, this.props.score有可能是null或者undefined,只想让wm_poi_score = this.props.score或者 = ''字符串

        let score = wm_poi_score.toString();

        let scoreArray = score.split('.'); //把.前后的数字分为数组
